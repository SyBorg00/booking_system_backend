...
Route::middleware('auth:sanctum')->group(function () {
    ...
    */
    ...
    |APPOINTMENT SECTION
    |------------------------------------------------------------------------
    | The reason there's no business prefix is because the business_id is included in 
    | the request body, so we don't need to include it in the URL (also it will subsequently
    | use the availability route anyways. and also this
    | is for the customer anyways, they need global access)
    |========================================================================
    */
